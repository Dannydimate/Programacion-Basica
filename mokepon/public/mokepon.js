...
alturaQueBuscamos = anchoDelMapa * 600 / 850
...
//fetch permite realizar llamadas hacia otros servicios por medio de HTTP (hacia que Uri,metodo y enviar datos y recibir respuesta)
function unirseAlJuego(){
    fetch("http://192.168.0.6:8080/unirse")
        .then(function (res){
            if(res.ok){
                res.text()
...
function seleccionarMokepon(mascotaJugador){
    fetch(`http://192.168.0.6:8080/mokepon/${jugadorId}`, {
        method: "post",
        headers: {
...
function enviarAtaques(){
    fetch(`http://192.168.0.6:8080/mokepon/${jugadorId}/ataques`, {
        method: "post",
        headers:{
            "Content-Type": "application/json"
        },
...
function obtenerAtaques(){
    fetch(`http://192.168.0.6:8080/mokepon/${enemigoId}/ataques`)
        .then(function (res) {
            if(res.ok){
                res.json()
...
function enviarPosicion(x, y){
    fetch(`http://192.168.0.6:8080/mokepon/${jugadorId}/posicion`, {
        method: "post",
        headers:{
            "Content-Type": "application/json"
        },
